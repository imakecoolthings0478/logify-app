...
import { X, Radio, ShieldCheck, Lock, KeyRound, AlertCircle, TicketPercent, Save, LogOut, Wifi, WifiOff, RefreshCw } from 'lucide-react';
...
const AdminPanel: React.FC<AdminPanelProps> = ({ currentStatus, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-200">
      <div className="bg-slate-900 border border-slate-700 w-full max-w-5xl rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row max-h-[90vh] h-[600px]">
